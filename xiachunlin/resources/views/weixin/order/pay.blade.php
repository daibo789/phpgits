    ...
    <div class="payment mt10">
        ...
        <dl class="defray">
            ...
            <dd>
                ...
                <label for="payment_yuer"><p class="logo"><img src="/weixins/images/yuepay_icon.png"></p>
                <p class="explain">余额支付</p></label>
            </dd>
            <?php } ?>
            <dd>
                <p class="radio"><input id="payment_wxpay" name="payment_id" value="2" type="radio" checked="checked"></p>
                <label for="payment_wxpay"><p class="logo"><img src="/weixins/images/wxpay_icon.png"></p>
