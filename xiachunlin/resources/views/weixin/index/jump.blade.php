...
<title>温馨提示！</title><meta content="width=device-width,initial-scale=1.0,minimum-scale=1.0,maximum-scale=1.0,user-scalable=0" name="viewport">
<link href="<?php echo env('APP_URL'); ?>/css/weixin/style.css" type="text/css" rel="stylesheet">
<meta name="keywords" content="温馨提示"><meta name="description" content="温馨提示"></head><body>
<style>
...
<div class="classreturn loginsignup">
    ...
    <div class="ds-in-bl tit center"><span>温馨提示</span></div>
</div>
<?php
/** 参数说明 
...
<div class="successsystem">
    <?php if(isset($_REQUEST['message'])) {?>
        <img src="/weixins/images/icogantanhao.png">
    <?php }else{ ?>
        <img src="/weixins/images/icogantanhao-sb.png">
    <?php }?>
</div>
<p class="prompt_s">
    <?php if(isset($_REQUEST['message'])) { ?>
