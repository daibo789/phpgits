...
<div id="search-placeholder" class="search">
    <div class="search_box">
        ...
        <span class="search_btn"><img src="/weixins/images/search.png"></span>
...
<div class="floor home_menu" style="background-color:#fff;border-bottom:1px solid #f0f0f0;border-top:1px solid #f0f0f0;">
    <nav>
        <a href="<?php echo route('weixin_category_goods_list'); ?>">
                <img src="/weixins/images/icon_05.png" alt="全部分类" />
                <span>全部分类</span>
        </a>
        <a href="<?php echo route('weixin_brand_list'); ?>">
                <img src="/weixins/images/icon_07.png" alt="品牌街" />
                <span>品牌街</span>
        </a>
        <a href="<?php echo route('weixin_goods_list',array('orderby'=>5)); ?>">
                <img src="/weixins/images/icon_15.png" alt="优惠商品" />
                <span>优惠商品</span>
        </a>
        <a href="<?php echo route('weixin_order_list'); ?>">
                <img src="/weixins/images/icon_16.png" alt="我的订单" />
                <span>我的订单</span>
        </a>
        <a href="<?php echo route('weixin_cart'); ?>">
                <img src="/weixins/images/icon_17.png" alt="购物车" />
                <span>购物车</span>
        </a>
        <a href="<?php echo route('weixin_user'); ?>">
                <img src="/weixins/images/icon_19.png" alt="个人中心" />
                <span>个人中心</span>
        </a>
        <a href="javascript:;">
                <img src="/weixins/images/icon_03.png" alt="敬请期待" />
                <span>敬请期待</span>
        </a>
    </nav>
</div>
...
<div class="home_toutiao" style="border-bottom:1px solid #f0f0f0;">
    <div class="home_toutiao_tit"><img src="/weixins/images/ad_tit.png"></div>
...
<div class="floor guesslike" style="background-color:#fff;">
    ...
    <?php if($goods_sale_list){foreach($goods_sale_list as $k=>$v){ ?>
        ...
        <a href="{{route('weixin_goods_detail',array('id'=>$v['id']))}}"><li><span class="goods_thumb"><img alt="<?php echo $v['title']; ?>" src="<?php echo $v['litpic']; ?>"></span>
