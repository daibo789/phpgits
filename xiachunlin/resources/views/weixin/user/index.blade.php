    ...
    <div class="content">
        ...
        <div class="floor myorder">
            <div class="content30">
                <div class="order">
                    <div class="fl">
                        <img src="/weixins/images/mlist.png">
                        <span>我的订单</span>
                    </div>
                    <div class="fr">
            ...
            <ul>
                <li>
                    <a href="<?php echo route('weixin_order_list',array('status'=>1)); ?>">
                        <!-- <span>0</span> -->
                        <img src="/weixins/images/q1.png" alt="">
                        <p>待付款</p>
                    </a>
                </li>
                <li>
                    <a href="<?php echo route('weixin_order_list',array('status'=>3)); ?>">
                        <!-- <span>0</span> -->
                        <img src="/weixins/images/q2.png" alt="">
                        <p>待收货</p>
                    </a>
                </li>
                <li>
                    <a href="<?php echo route('weixin_order_list',array('status'=>4)); ?>">
                        <!-- <span>0</span> -->
                        <img src="/weixins/images/q3.png" alt="">
                        <p>待评价</p>
                    </a>
                </li>
                <li>
                    <a href="<?php echo route('weixin_order_list',array('status'=>5)); ?>">
                        <!-- <span>0</span> -->
                        <img src="/weixins/images/q4.png" alt="">
                        <p>退款/退货</p>
                    </a>
                </li>
            </ul>
        ...
        <div class="floor myorder mt10">
            <div class="content30">
                <div class="order">
                    <div class="fl">
                        <img src="/weixins/images/mwallet.png">
                        <span>我的钱包</span>
                    </div>
                    <div class="fr">
            ...
            <div class="myorder p">
                <div class="content30">
                    <a href="<?php echo route('weixin_user_address_list'); ?>">
                        <div class="order">
                            <div class="fl">
                                <img src="/weixins/images/w10.png">
                                <span>地址管理</span>
                            </div>
                            <div class="fr">
                                <i class="Mright"></i>
