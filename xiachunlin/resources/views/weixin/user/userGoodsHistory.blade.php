...
<?php if($user_goods_history){ ?>
    <ul class="goods_list_s cl">
        ...
        <li><a href="<?php echo route('weixin_goods_detail',array('id'=>$v['goods']['id'])); ?>"><span class="goods_thumb"><img alt="<?php echo $v['goods']['title']; ?>" src="<?php echo $v['goods']['litpic']; ?>"></span></a>
