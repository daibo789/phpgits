...
<h5 class="sub-header"><a href="/admin/goods">商品列表</a> > 修改商品</h5>

<form id="addarc" method="post" action="/admin/goods/doedit" role="form" enctype="multipart/form-data" class="table-responsive">{{ csrf_field() }}
    ...
    <tr>
        ...
        <td>
            <select name="typeid" id="typeid">
                <?php $catlist = category_tree(get_category('goods_types',0));foreach($catlist as $row){
