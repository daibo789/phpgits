...
@section('content')
<h5 class="sub-header"><a href="/admin/weixinmenu">栏目管理</a> > 栏目添加</h5>

<form method="post" action="/admin/weixinmenu/doadd" role="form" id="addcat" class="table-responsive">{{ csrf_field() }}
