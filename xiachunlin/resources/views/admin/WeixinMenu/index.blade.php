...
@section('content')
<h2 class="sub-header">微信自定义菜单</h2>[ <a href="/admin/weixinmenu/add">增加顶级菜单</a> ] [ <a onclick="createmenu_confirm('/admin/weixinmenu/createmenu')" href="javascript:;">生成菜单</a> ]<br><br>
...
<td><a href="/admin/weixinmenu/edit?id=<?php echo $row->id; ?>">更改</a> | <a onclick="delconfirm('/admin/weixinmenu/del?id=<?php echo $row->id; ?>')" href="javascript:;">删除</a><?php if($row->pid==0){ ?> | <a href="/admin/weixinmenu/add?reid=<?php echo $row->id; ?>">增加子类</a><?php } ?></td>
</tr><?php }} ?>
