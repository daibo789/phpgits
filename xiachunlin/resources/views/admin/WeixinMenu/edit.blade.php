...
@section('content')
<h5 class="sub-header"><a href="/admin/weixinmenu">菜单管理</a> > 菜单修改</h5>

<form method="post" action="/admin/weixinmenu/doedit" role="form" id="addcat" class="table-responsive">{{ csrf_field() }}
