...
@section('content')
<h5 class="sub-header"><a href="/admin/menu">菜单列表</a> > 菜单添加</h5>

<form id="addarc" method="post" action="/admin/menu/doadd" role="form" enctype="multipart/form-data" class="table-responsive">{{ csrf_field() }}
