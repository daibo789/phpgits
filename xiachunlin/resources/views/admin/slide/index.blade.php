...
@section('content')
<h2 class="sub-header">轮播图管理</h2>[ <a href="/admin/slide/add">添加轮播图</a> ]<br><br>
...
<td><a href="/admin/slide/edit?id=<?php echo $row->id; ?>">修改</a> | <a onclick="delconfirm('/admin/slide/del?id=<?php echo $row->id; ?>')" href="javascript:;">删除</a></td>
</tr><?php }} ?>
