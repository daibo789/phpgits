...
@section('content')
<h5 class="sub-header"><a href="/admin/slide">轮播图列表</a> > 添加轮播图</h5>

<form id="addarc" method="post" action="/admin/slide/doadd" role="form" enctype="multipart/form-data" class="table-responsive">{{ csrf_field() }}
