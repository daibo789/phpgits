...
<script type="text/javascript" src="/vendor/js/layer/layer.js"></script>
...
function change_status(id,type)
{
    ...
    layer.confirm('您确定要执行此操作吗？', {
        ...
        $.post('<?php echo route('admin_userwithdraw_change_status'); ?>',
            {'_token': $('meta[name="csrf-token"]').attr('content'),id:id,type:type},
