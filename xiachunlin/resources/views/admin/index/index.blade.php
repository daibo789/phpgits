...
<html><head><title>{{sysconfig('CMS_WEBNAME')}}后台管理</title>
    ...
    <link rel="stylesheet" href="<?php echo route('home'); ?>/css/admin.css">
    <script src="{{route('home')}}/js/jquery.min.js"></script>
    <script src="<?php echo route('home'); ?>/js/respond.min.js"></script>
    <script src="<?php echo route('home'); ?>/js/ad.js"></script>
