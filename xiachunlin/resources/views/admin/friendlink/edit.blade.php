...
@section('content')
<h5 class="sub-header"><a href="/admin/friendlink">友情链接列表</a> > 友情链接修改</h5>

<form id="addarc" method="post" action="/admin/friendlink/doedit" role="form" enctype="multipart/form-data" class="table-responsive">{{ csrf_field() }}
