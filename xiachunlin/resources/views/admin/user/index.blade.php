...
@section('content')
<h2 class="sub-header">会员列表</h2>[ <a href="{{route('admin_user_add')}}">添加会员</a> ] [ <a href="{{route('admin_user_money')}}">账户记录</a> ] [ <a href="{{route('admin_userrank')}}">会员等级</a> ]<br><br>
...
<td><?php if($row->nickname){echo $row->nickname;}else{echo $row->user_name;} ?></td>
