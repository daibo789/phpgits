...
@section('content')
<h5 class="sub-header"><a href="/admin/tag">Tag列表</a> > 添加Tag</h5>

<form id="addarc" method="post" action="/admin/tag/doadd" role="form" enctype="multipart/form-data" class="table-responsive">{{ csrf_field() }}
