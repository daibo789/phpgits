...
@section('content')
<h5 class="sub-header"><a href="/admin/tag">Tag列表</a> > 修改Tag</h5>

<form id="addarc" method="post" action="/admin/tag/doedit" role="form" enctype="multipart/form-data" class="table-responsive">{{ csrf_field() }}
