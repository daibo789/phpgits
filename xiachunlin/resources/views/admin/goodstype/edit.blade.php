...
@section('content')
<h5 class="sub-header"><a href="/admin/goodstype">商品分类管理</a> > 修改分类</h5>

<form method="post" action="/admin/goodstype/doedit" role="form" id="addcat" class="table-responsive">{{ csrf_field() }}
