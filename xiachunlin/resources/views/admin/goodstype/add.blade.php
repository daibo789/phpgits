...
@section('content')
<h5 class="sub-header"><a href="/admin/goodstype">商品分类管理</a> > 添加分类</h5>

<form method="post" action="/admin/goodstype/doadd" role="form" id="addcat" class="table-responsive">{{ csrf_field() }}
