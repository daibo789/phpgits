...
@section('content')
<h5 class="sub-header"><a href="/admin/sysconfig">系统配置参数</a> > 参数修改</h5>

<form id="addarc" method="post" action="/admin/sysconfig/doedit" role="form" enctype="multipart/form-data" class="table-responsive">{{ csrf_field() }}
...
$(function(){
    ...
    $("#varname").blur(function(){
        var reg = /^CMS_[a-z]+[_][a-z]+$/i; // 创建正则表达式模式
        var str = this.value;
