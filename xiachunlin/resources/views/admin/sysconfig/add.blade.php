...
@section('content')
<h5 class="sub-header"><a href="/admin/sysconfig">系统配置参数</a> > 添加参数</h5>

<form id="addarc" method="post" action="/admin/sysconfig/doadd" role="form" enctype="multipart/form-data" class="table-responsive">{{ csrf_field() }}
