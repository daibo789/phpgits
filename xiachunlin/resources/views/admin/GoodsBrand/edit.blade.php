...
@section('content')
<h5 class="sub-header"><a href="/admin/goodsbrand">品牌列表</a> > 品牌修改</h5>

<form id="addarc" method="post" action="/admin/goodsbrand/doedit" role="form" enctype="multipart/form-data" class="table-responsive">{{ csrf_field() }}
